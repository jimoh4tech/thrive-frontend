...
export const enterpriseHub = {
  link: 'http://enterprisehubs.com/',
  title: ' Enterprise Hub',
  logo: ehub,
  text: `<p><Enterprise Hubs is an entrepreneurship resource service focused on providing sustainable digital and physical space for entrepreneurs to thrive.  Their model includes shared coworking facilities in urban centers, virtual marketplaces, digitally enabled back-office services offered on pay as you need basis, and, ultimately, suburban venture villages. </p><p>

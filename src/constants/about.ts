...
export const otsu = {
  ...
  desc: `<p>Your own searchable mini website, virtual office, a marketplace for your business, thousands of ready-to-use templates, and more. A world of business solutions.</p>
...
export const missVis = {
  mission: {
    ...
    desc: `Working with our partners and sponsors, to build and operate a viable one-stop digital platform of support services for micro, small and medium enterprises.`,
  },
  vision: {
    title: 'Our Vision',
    icon: 'ph:binoculars',
    desc: `Expand the economic contribution of growing businesses by providing best-in-class sustainable, scalable entrepreneurship support solutions on a digital platform.`,
  },
};
